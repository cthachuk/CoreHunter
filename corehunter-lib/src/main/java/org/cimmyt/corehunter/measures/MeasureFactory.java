...
public final class MeasureFactory {
  ...
  private static final String[] measureNames = {"MR","CE","SH", "HE", "NE", "PN", "CV"};
  
    public static Measure createMeasure(String measureName) throws UnknownMeasureException {
    if (measureName.equals("MR")) {
        return new ModifiedRogersDistance();
    } else if (measureName.equals("CE")) {
        return new CavalliSforzaEdwardsDistance();
